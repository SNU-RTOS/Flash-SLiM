...
usdt:./io_test:mytest:logic_start
{
    @logic_start[tid] = nsecs;
}

usdt:./io_test:mytest:logic_end
/@logic_start[tid]/
{
    ...
    // cleanup
    delete(@logic_start[tid]); delete(@io_duration_ms[tid]); delete(@start[tid]);
...
usdt:./io_test:mytest:io_start
{
    @start[tid] = nsecs;
}

usdt:./io_test:mytest:io_end
/@start[tid]/
{
